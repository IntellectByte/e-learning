        ...
        <>
            <div className='bluemoon'>
                <div className='content-container'>
                    ...
                    <p class='title'>Gracias por tu compra!</p>
                    <p class='subtitle'>
                        En el mail te tiene que estar llegando la info del curso
                        que compraste porfavor revisalo. Una vez que revisaste
                        clickea el boton de abajo.
                    </p>
